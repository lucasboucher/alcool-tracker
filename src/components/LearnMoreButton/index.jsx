...
function LearnMoreButton({ isLearnMoreOpen, onClick }) {
  return (
    <button
      onClick={onClick}
      className="relative -top-2 flex w-full justify-between rounded-b-lg border border-t-0 border-dark-3 px-2 pb-3 pt-5 font-medium transition-colors active:bg-dark-2"
    >
      En savoir plus
