...
function LearnMore({ className }) {
  ...
  return (
    ...
    >
      <motion.h2 className="mb-2 font-crucial text-xl" variants={item}>
        Guide de fonctionnement
      </motion.h2>
      <motion.p className="mb-2" variants={item}>
      ...
      <motion.div className="mb-6 flex justify-between gap-3" variants={item}>
