    ...
    <div className="relative flex w-full flex-col justify-center rounded bg-dark-2 px-2 py-4">
      {openHealthModal && (
        <button
          ...
          className={`absolute right-1 top-1 flex h-8 w-8 items-center justify-center rounded text-white transition duration-200 ease-out active:bg-dark-3 active:opacity-100 ${isHealthModalOpen && 'bg-dark-3 opacity-100'} ${bloodAlcoholLevel > 0.2 ? 'animate-pulse' : 'opacity-50'}`}
        >
